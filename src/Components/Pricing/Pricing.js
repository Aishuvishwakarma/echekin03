...
function Pricing() {
    return (
        <>
            ...
            <div className="col d-flex flex-column align-items-center justify-content-center  priningsctn">
                        <div className="pricingbx bg-light">
                            ...
                            <i class="ri-arrow-drop-down-line" id='drop'></i>
